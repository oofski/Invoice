...
import { Card, Button, Input, Select, Spinner, EmptyState } from "@/components/ui/primitives";
...
export default function VendorsPage() {
  ...
  async function addVendor() {
    ...
    try {
      ...
      toast.error(err instanceof ApiClientError ? err.message : "Add failed");
    } finally {
      setSaving(false);
    }
  }
                    ...
                    <tr className="border-b border-slate-100 bg-blue-50/40">
                      <td className="px-4 py-2">
                        <Input
                          ...
                          onChange={(e) =>
                            setNewRow((r) => ({ ...r, vendor_name: e.target.value }))
                          }
                        />
                      </td>
                      <td className="px-4 py-2">
